...
ActiveRecord::Schema[7.1].define(version: 2024_08_28_170547) do
  ...
  create_table "polling_locations", force: :cascade do |t|
    ...
    t.index ["riding_id", "title", "address", "city", "postal_code"], name: "idx_on_riding_id_title_address_city_postal_code_6af07d9af5", unique: true
